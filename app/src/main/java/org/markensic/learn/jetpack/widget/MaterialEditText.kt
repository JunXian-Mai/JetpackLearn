...
class MaterialEditText(
    ...
    var labelTextpaddingBottom = 3f.dp
    ...
    init {
        ...
        val defaultLabelSize =
            if (paint.textSize - 7.dp > 0) paint.textSize - 7f.dp else 11f.dp
        val defaultLabelColor = hintTextColors.getColorForState(
        ...
        labelTextSize =
            ty.getDimension(R.styleable.MaterialEditText_floatLabelSize, defaultLabelSize)
        labelTextColor =
            ty.getColor(R.styleable.MaterialEditText_floatLabelColor, defaultLabelColor)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (enableFloatLabel) {
            ...
            val drawLabelY =
                toPaddingTop - labelTextpaddingBottom + (1f - animFraction) * paint.textSize
            labelPaint.textSize =
                labelTextSize + (paint.textSize - labelTextSize) * (1f - animFraction)
